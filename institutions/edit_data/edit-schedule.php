                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                ...
                                <div class="form-group <?php echo (!empty($grade_err)) ? 'has-error' : ''; ?>">
                                    <label>Sem Group</label>
                                    <input type="text" name="grade" class="form-control" value="<?php echo $grade; ?>" placeholder="Enter Schedule Sem Group"> <!-- input that gonna be edited -->
