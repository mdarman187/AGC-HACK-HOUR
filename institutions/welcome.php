...
<body>
    ...
    <div class="jumbotron" style="background-color: black; padding:5%;">
        ...
        <p class="text-center" style="font-family: 'Coustard', serif; color: white;">We hope you are having a great day!</p>

        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                        <a type="submit" class="btn" style="font-size: 45px; font-family: 'Coustard', serif; background-color:#5A5C9C; color: rgb(255, 255, 255);"href="insert_data_php/main-insert-page.php">Insert Records</a>
                </div>
                <br>
                <div class="col-md-12 text-center" style="padding-top: 2%;">
                        <a type="submit" class="btn" style="font-size: 45px; font-family: 'Coustard', serif; background-color:#433F61; color: rgb(255, 255, 255);"href="show_data/main-search.php">Search Records</a>
                </div>
            </div>
