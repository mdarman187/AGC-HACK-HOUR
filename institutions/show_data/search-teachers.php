...
<head>
    <meta charset="utf-8">
    <title>Search Teachers</title> <!-- title for the page  -->
...
<body>
    ...
    <div class="col-13 col-sm-6 col-md-5 mx-auto" style="padding: 2%;"> 
        <div class="form-group">
          <h2 class="text-center" style=" font-size: 45px; font-family:'Coustard', serif; color: #FFFFFF; background-color:#353a40;">Search Teacher</h2>
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($user = mysqli_fetch_array($result)) {
                            ...
                            echo ("<td align='center'><a href=\"../edit_data/edit-teacher.php?teacher_id=".$user['id']."\">Edit</a></td>");
                            echo ("<td align='center'><a href=\"../remove_data/remove-teacher.php?teacher_id=".$user['id']."\">Remove</a></td>");
                            echo "</tr>";
