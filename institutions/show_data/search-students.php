...
<head>
    <meta charset="utf-8">
    <title>Search Students</title> <!-- title for the page  -->
        ...
        <table class="table table-bordered table-striped table-dark" style="width: 100%;">
            <thead>
                <tr>
                    ...
                    <th style="text-align: center;width: 10%;">Parent Name</th>
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($user = mysqli_fetch_array($result)) {
                            ...
                            echo "<td align='center'>" . $user['date_of_birth'] . "</td>";
                            echo "<td align='center'>" . $user['date_of_register'] . "</td>";
                            echo ("<td align='center'><a href=\"../edit_data/edit-student.php?student_id=".$user['id']."\">Edit</a></td>");
                            echo ("<td align='center'><a href=\"../remove_data/remove-student.php?student_id=".$user['id']."\">Remove</a></td>");
                            echo "</tr>";
