...
<head>
    <meta charset="utf-8">
    <title>Search Activites</title> <!-- title for the page  -->
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($user = mysqli_fetch_array($result)) {
                            ...
                            echo "<td align='center'>" . $user['explanation'] . "</td>";
                            ...
                            echo ("<td align='center'><a href=\"../edit_data/edit-activity.php?activity_id=".$user['id']."\">Edit</a></td>");
                            echo ("<td align='center'><a href=\"../remove_data/remove-activity.php?activity_id=".$user['id']."\">Remove</a></td>");
                            echo "</tr>";
