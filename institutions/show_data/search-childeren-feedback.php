...
<head>
    <meta charset="utf-8">
    <title>Search Child Feedbacks</title> <!-- title for the page  -->
...
<body>
    ...
    <div class="col-13 col-sm-6 col-md-5 mx-auto" style="padding: 2%;"> 
        <div class="form-group">
          <h2 class="text-center" style=" font-size: 45px; font-family:'Coustard', serif; color: #FFFFFF; background-color:#353a40;">Search Feedbacks</h2>
          <input type="text" name="search" id="search" autocomplete="off" class="form-control" placeholder="Enter Feedback Name">
        ...
        <table class="table table-bordered table-striped table-dark">
            <thead>
                <tr>
                    ...
                    <th style="text-align: center;">Date of Feedback</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    $query = "SELECT * FROM children_feedback ORDER BY teacher_name";
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($user = mysqli_fetch_array($result)) {
                            ...
                            echo "<td align='center'>" . $user['feedback'] . "</td>";
                            echo "<td align='center'>" . $user['teacher_name'] . "</td>";
    ...
    $(document).ready(function() {
      $("#search").keyup(function() {
        ...
        if (query != "") {
          $.ajax({
            url: '../search_data/search-child-feedback.php',
            method: 'POST',
            data: {
              query: query
            },
