...
<head>
    <meta charset="utf-8">
    <title>Search Complaints</title> <!-- title for the page  -->
        ...
        <table class="table table-bordered table-striped table-dark">
            <thead>
                <tr>
                    ...
                    <th style="text-align: center;">Date of Complaint</th>
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($user = mysqli_fetch_array($result)) {
                            ...
                            $id = $user['id'];
                            echo "<td align='center'>" . $user['type'] . "</td>";
                            echo "<td align='center'>" . $user['name'] . "</td>";
                            echo "<td align='center'>" . $user['number'] . "</td>";
                            echo "<td align='center'>" . $user['title'] . "</td>";
                            echo "<td align='center'>" . $user['feedback'] . "</td>";
                            echo "<td align='center'>" . $user['date_of_complant'] . "</td>";
                            echo ("<td align='center'><a href=\"../remove_data/remove-complant.php?complant_id=".$user['id']."\">Remove</a></td>");
                            echo "</tr>";
